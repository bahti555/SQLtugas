...
-- Menampilkan nama mahasiswa urut abjad --
...
-- Menampilkan nilai akhir mahasiswa antara 75 dan 85 --

SELECT akhir FROM krs WHERE akhir>75 AND akhir<85;

-- menampilkan mahasiswa yng mendapat huruf B --

SELECT nim, huruf FROM krs WHERE huruf='B';

-- Menampilkan nim, nama, dan banyaknya sks yang diambil mahasiswa --

SELECT nim, nama, sks FROM mahasiswa;

-- Menampilkan alamat mahasiswa(alamat yg sama hanya tampil sekali) --

SELECT DISTINCT alamat FROM mahasiswa;

-- menampilkan nama dan alamat mahasiswa yang beralamat di kota semarang dan demak  --

SELECT nama, alamat FROM mahasiwa WHERE alamat='semarang' OR alamat='demak';